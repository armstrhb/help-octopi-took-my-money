...
public class MySQLFinanceDao implements FinanceDao {
	...
	public List<Bill> getBills() {
		return template.query("select bill_id, bill_name, bill_account_number, bill_created, bill_updated, bill_active, bill_notes, bill_day_of_month_due, bill_website, bill_phone_number, bill_initial_balance, bill_payment_plan_amount from bill", new BillMapper());
	}
